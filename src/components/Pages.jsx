...
function Pages() {
    ...
    return (
        <div>
                            ...
                            <div key={productItem.id} className=" w-80 h-107 rounded-3xl shadow-lg bg-white">
                                ...
                                <div className=" p-5">
                                    <div className=" flex justify-between ">
                                        <span className="text-gray-500 font-bold ">{productItem.category.toUpperCase()} </span>
                                        <span className=" flex items-center font-bold text-gray-500 " > <MdStars className=" text-yellow-500 text-xl mr-1" />{productItem.rating}</span>
                                    </div>
                                    ...
                                    <div className=" flex justify-between">
                                        ...
                                        <Button className="w-40 h-10 rounded-xl bg-gray-700 hover:bg-gray-800 text-white shadow-lg cursor-pointer">Buy</Button>
                                    </div>
                                </div>
                            </div>
                        )
            ...
            <div className=" flex flex-wrap justify-center items-center gap-2 sm:gap-3 mb-10 px-2">

                <Button disabled={currentPage === 1} onClick={() => setCurrentPage(currentPage - 1)}
                    className="bg-gray-300 text-black hover:bg-gray-400 disabled:opacity-50 text-sm sm:text-md px-3 sm:px-4">
                    Prev</Button>
                ...
                <div className="flex flex-wrap justify-center gap-1 sm:gap-2">
                    {[...Array(totalPages)].map((_, index) => (
                        <Button
                            ...
                            className={`px-3 py-2 sm:px-4 sm:py-2 text-sm sm:text-md rounded-lg border font-semibold
                             ${currentPage === index + 1
