   ...
   function searchProducts(){ 
    ...
    return (
        <div className=" flex justify-center gap-3 mt-10 sticky top-10 z-10">
            ...
            className=" w-70 h-10  rounded-md p-4 focus:outline-none focus:ring-2 focus:ring-gray-400 bg-white border-2 border-gray-300"/>
             <Button onClick={handleSearch} className=" w-30 h-10">Search</Button>
